...
import {
  ...
  transition,
  trigger
} from "./chunk-64T7GR2B.js";
import {
  DOCUMENT,
  Location,
  isPlatformBrowser
} from "./chunk-2HSASB5C.js";
import {
...
var OverlayRef = class {
  ...
  attach(portal) {
    ...
    this._ngZone.onStable.pipe((0, import_operators6.take)(1)).subscribe(() => {
      if (this.hasAttached()) {
        this.updatePosition();
      }
    });
  ...
  _detachContentWhenStable() {
    this._ngZone.runOutsideAngular(() => {
      const subscription = this._ngZone.onStable.pipe((0, import_operators6.takeUntil)((0, import_rxjs7.merge)(this._attachments, this._detachments))).subscribe(() => {
